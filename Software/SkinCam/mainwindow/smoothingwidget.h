...
public:
    ...
    void applySettings(const Settings::SmoothingGroup& settings);
    void storeSettings(Settings::SmoothingGroup* settings);
...
private slots:
    void handleRadiusChange();

private:
    std::unique_ptr<Ui::SmoothingWidget> m_ui;
};
